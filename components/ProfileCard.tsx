...
const ProfileCardComponent = ({
    ...
    const getOffsets = (evt: MouseEvent | React.PointerEvent, el: HTMLElement) => {
    ...
    useEffect(() => {
        ...
        // Cast to any to avoid strict type issues with DOM event listeners vs React event handlers
